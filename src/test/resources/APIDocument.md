...
{
	"name":"someone",
	"password":"F+sJ0zDpOpBg5VbkMcmf0zooVCpG/JXpK29u9unxwcoURCrN5nuyEdJXAbE3mWyt1R8xAqRFOBlOltJjdIu+39hlH5QmN/KasTn9sHi/AAcpZkLpNPwnIel/zb8nC9TUfROtp0Dk42vbpkN5XdZw/+JJ8D9mQ9m8nuzF7DZqZnc=",
	"email":"someone@gmail.com"
}
```
...
**URL**
http://localhost:8007/login?identity=someone&password=i0hz%2Brv%2BSOBWp3o4DjVB36x0tjR%2BAETEQ7CnI%2BYIh4%2Bu%2F9BGWfij24z56fIKHFI1fweiNU5rVQEye2j1fwKmuxcKvk0O1ZrrIf3yxK%2FJS2%2BuQLZlL%2FjiOLim4BB6dIV8kXAREqW7dTNO27ODdLdnK8lXk8wChlOAkEF6d0DItzE%3D

**响应体**
```
{
	"timestamp":1475806715355,
	"status":400,
	"error":"Bad Request",
	"exception":"org.thiki.kanban.foundation.exception.InvalidParamsException",
	"message":"用户名或密码错误。",
...
**URL**
http://localhost:8007/login?identity=someone&password=Gjcy5UFvN1rvdSX4lMRFuohTeLqA%2FbgoA3NKfWduubPZ6M8V%2FdyLFwpgeuyekasHYM5%2BGgpLqSh4bLjFlqNJFS4qAhejNZV9GddmPjGaB7fQBGkVbI4I90AVcqtGavRVeOTfGvaxNJIPVPcjcC06aqpwfGO71ktTPwePhTuFxrU%3D
...
```
{
	"creationTime":"2016-10-07 10:18:26.128000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/someone/boards"
		},
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:26.128000",
	"name":"new-name",
	"id":"fooId"
}
```
...
```
{
	"creationTime":"2016-10-07 10:18:26.282000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/someone/boards"
		},
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:26.282000",
	"name":"board-name",
	"id":"fooId"
}
```
...
[
	{
		"creationTime":"2016-10-07 10:18:26.627000",
		"_links":{
			"all":{
				"href":"http://localhost:8007/someone/boards"
			},
		...
		"author":"someone",
		"modificationTime":"2016-10-07 10:18:26.627000",
		"name":"board-name",
		"id":"fooId"
	}
]
...
```
{
	"creationTime":"2016-10-07 10:18:26.707000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/someone/boards"
		},
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:26.707000",
	"name":"board-name",
	"id":"fooId"
}
```
...
{
	"orderNumber":1,
	"creationTime":"2016-10-07 10:18:40.144000",
	"_links":{
		"all":{
	...
	"author":"fooName",
	"modificationTime":"2016-10-07 10:18:40.144000",
	"boardId":"feeId",
	"id":"fooId",
	"title":"title."
}
...
{
	"orderNumber":0,
	"creationTime":"2016-10-07 10:18:40.204000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-10-07 10:18:40.204000",
	"boardId":"feeId",
	"id":"fooId",
	"title":"newTitle"
}
...
{
	"orderNumber":0,
	"creationTime":"2016-10-07 10:18:40.263000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-10-07 10:18:40.263000",
	"boardId":"feeId",
	"id":"fooId2",
	"title":"newTitle"
}
...
{
	"orderNumber":0,
	"creationTime":"2016-10-07 10:18:40.348000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-10-07 10:18:40.348000",
	"boardId":"feeId",
	"id":"fooId",
...
[
	{
		"orderNumber":0,
		"creationTime":"2016-10-07 10:18:40.461000",
		"_links":{
			"all":{
				"href":"http://localhost:8007/boards/feeId/procedures"
			},
		...
		"author":"tao",
		"modificationTime":"2016-10-07 10:18:40.461000",
		"boardId":"feeId",
		"id":"fooId",
		"title":"this is the first procedure."
	}
...
{
	"orderNumber":2,
	"creationTime":"2016-10-07 10:18:40.685000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-10-07 10:18:40.685000",
	"boardId":"feeId",
	"id":"fooId1",
	"title":"newTitle"
}
...
{
	"orderNumber":0,
	"creationTime":"2016-10-07 10:18:40.812000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"fooName",
	"modificationTime":"2016-10-07 10:18:40.812000",
	"boardId":"feeId",
	"id":"fooId",
	"title":"this is the procedure title."
}
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-10-07 10:18:26.855000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-10-07 10:18:26.855000",
	"id":"fooId2",
	"procedureId":"1"
}
```
...
```
{
	...
	"orderNumber":0,
	"creationTime":"2016-10-07 10:18:27.055000",
	"_links":{
		"assignments":{
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:27.055000",
	"id":"1",
	"procedureId":"1",
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-10-07 10:18:27.114000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-10-07 10:18:27.114000",
	"id":"fooId6",
	"procedureId":"1"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":1,
	"creationTime":"2016-10-07 10:18:27.185000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-10-07 10:18:27.185000",
	"id":"fooId4",
	"procedureId":"1"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-10-07 10:18:27.310000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-10-07 10:18:27.310000",
	"id":"fooId",
	"procedureId":"1"
}
```
...
[
	{
		"summary":"this is the card summary.",
		"orderNumber":0,
		"creationTime":"2016-10-07 10:18:27.445000",
		"_links":{
			"assignments":{
		...
		"author":"someone",
		"modificationTime":"2016-10-07 10:18:27.445000",
		"id":"1",
		"procedureId":"fooId",
		"content":"play badminton"
	}
...
```
{
	"summary":"summary",
	"orderNumber":0,
	"creationTime":"2016-10-07 10:18:27.652000",
	"_links":{
		"assignments":{
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:27.652000",
	"id":"fooId",
	"procedureId":"fooId"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-10-07 10:18:27.724000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-10-07 10:18:27.724000",
	"id":"fooId1",
	"procedureId":"1"
}
```
...
```
{
	"creationTime":"2016-10-07 10:18:49.529000",
	"_links":{
		"members":{
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:49.529000",
	"name":"team-name",
	"id":"fooId"
}
```
...
[
	{
		"creationTime":"2016-10-07 10:18:49.631000",
		"_links":{
			"members":{
				"href":"http://localhost:8007/teams/fooId/members"
			},
		...
		"author":"someone",
		"modificationTime":"2016-10-07 10:18:49.631000",
		"name":"team-name",
		"id":"fooId"
	}
]
...
```
{
	"creationTime":"2016-10-07 10:18:49.714000",
	"_links":{
		"members":{
			"href":"http://localhost:8007/teams/fooId/members"
		},
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:49.714000",
	"name":"思奇团队讨论组",
	"id":"fooId"
}
```
...
```
{
	"creationTime":"2016-10-07 10:18:41.680000",
	"_links":{
		"self":{
	...
	"modificationTime":"2016-10-07 10:18:41.680000",
	"isAccepted":false,
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
...
```
{
	"creationTime":"2016-10-07 10:18:43.687000",
	"_links":{
		"self":{
			"href":"http://localhost:8007/teams/foo-team-Id/members/invitation/fooId"
		},
	...
	"modificationTime":"2016-10-07 10:18:43.687000",
	"isAccepted":false,
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
...
```
{
	"creationTime":"2016-10-07 10:18:45.663000",
	"_links":{
		"self":{
	...
	"modificationTime":"2016-10-07 10:18:45.663000",
	"isAccepted":false,
	"teamId":"foo-team-id",
	"inviter":"someone",
	"id":"invitation-id",
...
```
{
	"creationTime":"2016-10-07 10:18:45.713000",
	"_links":{
		"self":{
			"href":"http://localhost:8007/teams/foo-team-id/members/invitation/invitation-id"
		},
	...
	"modificationTime":"2016-10-07 10:18:45.713000",
	"isAccepted":true,
	"teamId":"foo-team-id",
	"inviter":"inviter",
	"id":"invitation-id",
...
```
{
	"creationTime":"2016-10-07 10:18:45.792000",
	"_links":{
		"self":{
			"href":"http://localhost:8007/teams/foo-team-Id/members/invitation/fooId"
		},
	...
	"modificationTime":"2016-10-07 10:18:45.792000",
	"isAccepted":false,
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
...
```
{
	"creationTime":"2016-10-07 10:18:47.746000",
	"_links":{
		"self":{
			"href":"http://localhost:8007/teams/foo-team-Id/members/invitation/fooId"
		},
	...
	"modificationTime":"2016-10-07 10:18:47.746000",
	"isAccepted":false,
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
...
```
{
	"creationTime":"2016-10-07 10:18:41.449000",
	"_links":{
		"self":{
	...
	"author":"someone",
	"modificationTime":"2016-10-07 10:18:41.449000",
	"teamId":"foo-teamId",
	"member":"someone",
	"id":"fooId"
}
...
```
{
	"password":"Mo81UtcRldvIPTEnrVijZwWwxsEbEJXuOGrgTqyDm6rKXQzMDSMBvkl6mkU+SldiNQsMibyGlYznQjoABy/nSWIr0ajtLN38kKBPViH0vzO2KfxAOMe6QbNJtDrsiZYQ2JBIowGstCuaQBxE4JqcLHfH4t4GllzYstyhid0yaS8="
}
```
...
```
{
	...
	"notifications":[
		{
			"displayTime":"刚刚",
			"creationTime":"2016-10-07 10:18:35.608000",
			"receiver":"someone",
...
{
	"displayTime":"刚刚",
	"creationTime":"2016-10-07 10:18:35.707000",
	"receiver":"someone",
	"sender":"sender@gmail.com",
	"_links":{
		"self":{
...
{
	"displayTime":"刚刚",
	"creationTime":"2016-10-07 10:18:35.797000",
	"receiver":"someone",
	"sender":"sender@gmail.com",
	"_links":{
		"self":{
...
```
{
	"creationTime":"2016-10-07 10:18:25.781000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/1/procedures"
		},
	...
	"author":"authorId-foo",
	"modificationTime":"2016-10-07 10:18:25.781000",
	"cardId":"cardId-foo",
	"assigner":"assignerId-foo",
	"name":"徐濤",
	"assignee":"assigneeId-foo",
...
```
{
	"creationTime":"2016-10-07 10:18:26.052000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/1/procedures"
		},
	...
	"author":"11222",
	"modificationTime":"2016-10-07 10:18:26.052000",
	"cardId":"fooId",
	"assigner":"assignerId",
	"assignee":"assigneeId",
	"id":"fooId"
