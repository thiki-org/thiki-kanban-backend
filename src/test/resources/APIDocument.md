...
```
{
	"creationTime":"2016-09-14 20:38:52.474000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/1/procedures"
		},
	...
	"author":"authorId-foo",
	"modificationTime":"2016-09-14 20:38:52.474000",
	"cardId":"cardId-foo",
	"assigner":"assignerId-foo",
	"name":"徐濤",
	"assignee":"assigneeId-foo",
...
```
{
	"creationTime":"2016-09-14 20:38:52.757000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/1/procedures"
		},
	...
	"author":"11222",
	"modificationTime":"2016-09-14 20:38:52.757000",
	"cardId":"fooId",
	"assigner":"assignerId",
	"assignee":"assigneeId",
	"id":"fooId"
...
```
{
	"creationTime":"2016-09-14 20:38:52.830000",
	"_links":{
		"all":{
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:38:52.830000",
	"name":"new-name",
	"id":"fooId"
}
```
...
```
{
	"creationTime":"2016-09-14 20:38:52.978000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/someone/boards"
		},
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:38:52.978000",
	"name":"board-name",
	"id":"fooId"
}
```
...
[
	{
		"creationTime":"2016-09-14 20:38:53.347000",
		"_links":{
			"all":{
				"href":"http://localhost:8007/someone/boards"
			},
		...
		"author":"someone",
		"modificationTime":"2016-09-14 20:38:53.347000",
		"name":"board-name",
		"id":"fooId"
	}
]
...
```
{
	"creationTime":"2016-09-14 20:38:53.435000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/someone/boards"
		},
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:38:53.435000",
	"name":"board-name",
	"id":"fooId"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-09-14 20:38:53.612000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-09-14 20:38:53.612000",
	"id":"fooId2",
	"procedureId":"1"
}
```
...
```
{
	...
	"orderNumber":0,
	"creationTime":"2016-09-14 20:38:53.846000",
	"_links":{
		"assignments":{
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:38:53.846000",
	"id":"1",
	"procedureId":"1",
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-09-14 20:38:53.920000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-09-14 20:38:53.920000",
	"id":"fooId6",
	"procedureId":"1"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":1,
	"creationTime":"2016-09-14 20:38:54.038000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-09-14 20:38:54.038000",
	"id":"fooId4",
	"procedureId":"1"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-09-14 20:38:54.164000",
	"_links":{
		"assignments":{
			"href":"http://localhost:8007/procedures/1/cards/fooId/assignments"
		},
	...
	"modificationTime":"2016-09-14 20:38:54.164000",
	"id":"fooId",
	"procedureId":"1"
}
```
...
[
	{
		"summary":"this is the card summary.",
		"orderNumber":0,
		"creationTime":"2016-09-14 20:38:54.281000",
		"_links":{
			"assignments":{
		...
		"author":"someone",
		"modificationTime":"2016-09-14 20:38:54.281000",
		"id":"1",
		"procedureId":"fooId",
		"content":"play badminton"
	}
...
```
{
	"summary":"summary",
	"orderNumber":0,
	"creationTime":"2016-09-14 20:38:54.489000",
	"_links":{
		"assignments":{
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:38:54.489000",
	"id":"fooId",
	"procedureId":"fooId"
}
```
...
```
{
	"summary":"newSummary",
	"orderNumber":3,
	"creationTime":"2016-09-14 20:38:54.581000",
	"_links":{
		"assignments":{
	...
	"modificationTime":"2016-09-14 20:38:54.581000",
	"id":"fooId1",
	"procedureId":"1"
}
```
...
**URL**
http://localhost:8007/error/invalidParamsException?identity=someone&password=YhulBIAtLLN%2FWWICncS3UrTay9PU7oAMwcAH3516KU74Gy6XtG%2FonsE4KTlD4An9HjKNSLOCAuGUPAw1UZ8srnl6R6mYTR6LN6h%2BJ2CzEimTpG6nQ9UYakjS1byN5AjGI6EdP6ACUz8CBsiUWpa6HJIS1B7zOilavIL%2FNeq9wVk%3D
...
**URL**
http://localhost:8007/login?identity=someone&password=nTEKRwSS7b5w7HQ7Qn%2BtBd8RLnl%2BXdlvn0%2B5N26LUOknU2lHwjjIwvSkreShXWfV6v8wI3LDzXW6itUdTgQRGBETInlR2B%2F286jwfr5rWVBNjqSyr7S7alchqP0pS0QX0rU6dWBtypQzCQEh3b5xTWHUL%2BxAKS68GlMZDbi%2Ff4I%3D
...
```
{
	"password":"ZtRnQWM4JzTVngHmlrhTcXI5/4OLeZ+H3lMHSWXO2n9d5reuJcMasT6u4aoaz8p/c7yjcVtGj1HVpi0ZytiE6AN+Dk7MZ2It4b2Mc2IlXndtPU0W/IuqciJsclcUXbasMGZJvly/o8pYlBBZihJBmMwngtlz1k0nV8w5xKsZw9s="
}
```
...
{
	"orderNumber":1,
	"creationTime":"2016-09-14 20:39:02.020000",
	"_links":{
		"all":{
	...
	"author":"fooName",
	"modificationTime":"2016-09-14 20:39:02.020000",
	"boardId":"feeId",
	"id":"fooId",
	"title":"title."
}
...
{
	"orderNumber":0,
	"creationTime":"2016-09-14 20:39:02.109000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-09-14 20:39:02.109000",
	"boardId":"feeId",
	"id":"fooId",
	"title":"newTitle"
}
...
{
	"orderNumber":0,
	"creationTime":"2016-09-14 20:39:02.233000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-09-14 20:39:02.233000",
	"boardId":"feeId",
	"id":"fooId2",
	"title":"newTitle"
}
...
{
	"orderNumber":0,
	"creationTime":"2016-09-14 20:39:02.296000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-09-14 20:39:02.296000",
	"boardId":"feeId",
	"id":"fooId",
...
[
	{
		"orderNumber":0,
		"creationTime":"2016-09-14 20:39:02.438000",
		"_links":{
			"all":{
				"href":"http://localhost:8007/boards/feeId/procedures"
			},
		...
		"author":"tao",
		"modificationTime":"2016-09-14 20:39:02.438000",
		"boardId":"feeId",
		"id":"fooId",
		"title":"this is the first procedure."
	}
...
{
	"orderNumber":2,
	"creationTime":"2016-09-14 20:39:02.691000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"1",
	"modificationTime":"2016-09-14 20:39:02.691000",
	"boardId":"feeId",
	"id":"fooId1",
	"title":"newTitle"
}
...
{
	"orderNumber":0,
	"creationTime":"2016-09-14 20:39:02.843000",
	"_links":{
		"all":{
			"href":"http://localhost:8007/boards/feeId/procedures"
		},
	...
	"author":"fooName",
	"modificationTime":"2016-09-14 20:39:02.843000",
	"boardId":"feeId",
	"id":"fooId",
	"title":"this is the procedure title."
}
...
```
{
	"creationTime":"2016-09-14 20:39:03.654000",
	"_links":{
		"self":{
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:39:03.654000",
	"teamId":"foo-teamId",
	"member":"someone",
	"id":"fooId"
}
...
```
{
	"creationTime":"2016-09-14 20:39:03.859000",
	"_links":{
		"members":{
	...
	"modificationTime":"2016-09-14 20:39:03.859000",
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
	"invitee":"invitee-user"
...
```
{
	"creationTime":"2016-09-14 20:39:04.805000",
	"_links":{
		"members":{
			"href":"http://localhost:8007/teams/foo-team-Id/members"
		},
	...
	"modificationTime":"2016-09-14 20:39:04.805000",
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
	"invitee":"invitee-user"
...
```
{
	"creationTime":"2016-09-14 20:39:05.740000",
	"_links":{
		"members":{
			"href":"http://localhost:8007/teams/foo-team-Id/members"
		},
	...
	"modificationTime":"2016-09-14 20:39:05.740000",
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
	"invitee":"invitee-user"
...
```
{
	"creationTime":"2016-09-14 20:39:06.730000",
	"_links":{
		"members":{
			"href":"http://localhost:8007/teams/foo-team-Id/members"
		},
	...
	"modificationTime":"2016-09-14 20:39:06.730000",
	"teamId":"foo-team-Id",
	"inviter":"someone",
	"id":"fooId",
	"invitee":"invitee-user"
...
```
{
	"creationTime":"2016-09-14 20:39:07.696000",
	"_links":{
		"members":{
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:39:07.696000",
	"name":"team-name",
	"id":"fooId"
}
```
...
[
	{
		"creationTime":"2016-09-14 20:39:07.809000",
		"_links":{
			"members":{
				"href":"http://localhost:8007/teams/fooId/members"
			},
		...
		"author":"someone",
		"modificationTime":"2016-09-14 20:39:07.809000",
		"name":"team-name",
		"id":"fooId"
	}
]
...
```
{
	"creationTime":"2016-09-14 20:39:07.888000",
	"_links":{
		"members":{
			"href":"http://localhost:8007/teams/fooId/members"
		},
	...
	"author":"someone",
	"modificationTime":"2016-09-14 20:39:07.888000",
	"name":"思奇团队讨论组",
	"id":"fooId"
}
```
