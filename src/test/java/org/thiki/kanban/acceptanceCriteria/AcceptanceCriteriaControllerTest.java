...
public class AcceptanceCriteriaControllerTest extends TestBase {
    ...
    public void create_shouldReturn201WhenCreateACSuccessfully() throws Exception {
        given().body("{\"summary\":\"AC-summary\"}")
                ...
                .when()
                .post("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias")
                .then()
                .statusCode(201)
    ...
    public void loadAcceptanceCriterias() throws Exception {
        ...
        given().header("userName", userName)
                .when()
                .get("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias")
                .then()
                .statusCode(200)
                ...
                .body("acceptanceCriterias[0]._links.self.href", endsWith("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias/fooId"))
    ...
    public void loadACById() throws Exception {
        ...
        given().header("userName", userName)
                .when()
                .get("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias/fooId")
                .then()
                .statusCode(200)
                .body("summary", equalTo("AC-summary"))
                .body("finished", equalTo(false))
    ...
    public void updateAC() throws Exception {
        ...
        given().header("userName", userName)
                ...
                .when()
                .put("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias/fooId")
                .then()
                .statusCode(200)
    ...
    public void deleteAC() throws Exception {
        ...
        given().header("userName", userName)
                .when()
                .delete("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias/fooId")
                .then()
                .statusCode(200)
                .body("_links.acceptanceCriterias.href", endsWith("/boards/boardId-foo/stages/stages-fooId/cards/card-fooId/acceptanceCriterias"));
    }
