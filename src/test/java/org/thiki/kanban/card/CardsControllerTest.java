...
public class CardsControllerTest extends TestBase {
    ...
    public void create_shouldReturn201WhenCreateCardSuccessfully() throws Exception {
        ...
        given().body("{\"summary\":\"summary\"}")
                ...
                .when()
                .post("/entries/fooId/cards")
                .then()
                .statusCode(201)
                .body("summary", equalTo("summary"))
                .body("reporter", equalTo(11222))
                .body("_links.self.href", equalTo("http://localhost:8007/entries/fooId/cards/fooId"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/fooId/cards"))
                .body("_links.assignments.href", equalTo("http://localhost:8007/entries/fooId/cards/fooId/assignments"));
    ...
    public void create_shouldCreateFailedWhenEntryIsNotFound() throws Exception {
        ...
        given().body("{\"summary\":\"summary\"}")
                ...
                .contentType(ContentType.JSON)
                .when()
                .post("/entries/non-exists-entryId/cards")
                .then()
                .statusCode(404)
    ...
    public void shouldReturnCardsWhenFindCardsByEntryIdSuccessfully() throws Exception {
        ...
        given().header("userId", "11222")
                ...
                .body("[0]._links.self.href", equalTo("http://localhost:8007/entries/fooId/cards/1"))
    ...
    public void findById_shouldReturnCardSuccessfully() throws Exception {
        ...
        given().header("userId", "11222")
                .when()
                .get("/entries/1/cards/1")
                .then()
                .statusCode(200)
                .body("summary", equalTo("this is the card summary."))
                .body("content", equalTo("play badminton"))
                .body("reporter", equalTo(1))
                .body("_links.self.href", equalTo("http://localhost:8007/entries/1/cards/1"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/1/cards"))
    ...
    public void update_shouldReturn200WhenUpdateCardSuccessfully() throws Exception {
        ...
        given().body("{\"summary\":\"newSummary\",\"orderNumber\":3,\"entryId\":1}")
                ...
                .body("_links.self.href", equalTo("http://localhost:8007/entries/1/cards/fooId"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/1/cards"))
    ...
    public void update_shouldResortSuccessfullyWhenCurrentOrderNumberLessThanOriginNumber() throws Exception {
        ...
        given().body("{\"summary\":\"newSummary\",\"orderNumber\":1,\"entryId\":1}")
                ...
                .contentType(ContentType.JSON)
                .when()
                .put("/entries/1/cards/fooId4")
                .then()
                .statusCode(200)
                .body("summary", equalTo("newSummary"))
                .body("orderNumber", equalTo(1))
                .body("_links.self.href", equalTo("http://localhost:8007/entries/1/cards/fooId4"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/1/cards"));
    ...
    private void prepareDataForResort() {
        jdbcTemplate.execute("INSERT INTO  kb_card (id,summary,content,reporter,entry_id,order_number) VALUES ('fooId1','this is the card summary.','play badminton',1,1,0)");
        jdbcTemplate.execute("INSERT INTO  kb_card (id,summary,content,reporter,entry_id,order_number) VALUES ('fooId2','this is the card summary.','play badminton',1,1,1)");
        jdbcTemplate.execute("INSERT INTO  kb_card (id,summary,content,reporter,entry_id,order_number) VALUES ('fooId3','this is the card summary.','play badminton',1,1,2)");
        jdbcTemplate.execute("INSERT INTO  kb_card (id,summary,content,reporter,entry_id,order_number) VALUES ('fooId4','this is the card summary.','play badminton',1,1,3)");
    ...
    public void update_shouldResortSuccessfullyWhenCurrentOrderNumberMoreThanOriginNumber() throws Exception {
        ...
        given().body("{\"summary\":\"newSummary\",\"orderNumber\":3,\"entryId\":1}")
                ...
                .contentType(ContentType.JSON)
                .when()
                .put("/entries/1/cards/fooId2")
                .then()
                .statusCode(200)
                .body("summary", equalTo("newSummary"))
                .body("orderNumber", equalTo(3))
                .body("_links.self.href", equalTo("http://localhost:8007/entries/1/cards/fooId2"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/1/cards"))
                .body("_links.assignments.href", equalTo("http://localhost:8007/entries/1/cards/fooId2/assignments"));
    ...
    public void update_shouldResortSuccessfullyWhenCurrentOrderNumberMoreThanOriginNumberButNotTheBiggest() throws Exception {
        ...
        given().body("{\"summary\":\"newSummary\",\"orderNumber\":3,\"entryId\":1}")
                ...
                .contentType(ContentType.JSON)
                .when()
                .put("/entries/1/cards/fooId1")
                .then()
                .statusCode(200)
                .body("summary", equalTo("newSummary"))
                .body("orderNumber", equalTo(3))
                .body("_links.self.href", equalTo("http://localhost:8007/entries/1/cards/fooId1"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/1/cards"))
                .body("_links.assignments.href", equalTo("http://localhost:8007/entries/1/cards/fooId1/assignments"));
    ...
    public void update_shouldResortSuccessfullyWhenCardIsFromAntherEntry() throws Exception {
        prepareDataForResort();
        jdbcTemplate.execute("INSERT INTO  kb_card (id,summary,content,reporter,entry_id,order_number) VALUES ('fooId6','this is the card summary.','play badminton',1,2,3)");
        given().body("{\"summary\":\"newSummary\",\"orderNumber\":3,\"entryId\":1}")
                .header("userId", "11222")
                .contentType(ContentType.JSON)
                .when()
                .put("/entries/1/cards/fooId6")
                .then()
                .statusCode(200)
                .body("summary", equalTo("newSummary"))
                .body("orderNumber", equalTo(3))
                .body("_links.self.href", equalTo("http://localhost:8007/entries/1/cards/fooId6"))
                .body("_links.cards.href", equalTo("http://localhost:8007/entries/1/cards"))
                .body("_links.assignments.href", equalTo("http://localhost:8007/entries/1/cards/fooId6/assignments"));
    ...
    public void delete_shouldDeleteSuccessfullyWhenTheCardIsExist() {
        ...
        given().header("userId", "11222")
                .when()
                .delete("/entries/feeId/cards/fooId")
                .then()
                .statusCode(200);
    ...
    public void delete_shouldDeleteFailedWhenTheCardIsNotExist() {
        given().header("userId", "11222")
                .when()
                .delete("/entries/feeId/cards/non-exists-cardId")
                .then()
                .statusCode(404)
                .body("code", equalTo(404))
