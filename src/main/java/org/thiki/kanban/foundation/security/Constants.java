...
public class Constants {
    ...
    public static final String FREE_IDENTIFICATION = "no";
    public static final String HEADER_PARAMS_TOKEN = "token";
    public static final String HEADER_PARAMS_USER_NAME = "userName";
    public static final String HEADER_PARAMS_IDENTIFICATION = "identification";
    public static final int TOKEN_EXPIRED_TIME = 1000;
