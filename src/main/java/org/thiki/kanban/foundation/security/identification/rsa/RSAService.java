package org.thiki.kanban.foundation.security.identification.rsa;
...
public class RSAService {
    ...
    public PublicKey getPublicKey(String base64PublicKey) {
        try {
            ...
            throw new IllegalArgumentException("Failed from authGet public key!", e);
        }
    }
    ...
    public PrivateKey getPrivateKey(String base64PrivateKey) {
        try {
            ...
            throw new InvalidParamsException("Failed from authGet private key!");
        }
    }
