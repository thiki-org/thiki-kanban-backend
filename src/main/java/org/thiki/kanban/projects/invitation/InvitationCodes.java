...
public enum InvitationCodes {
    PROJECT_IS_NOT_EXISTS("001", "团队不存在。"),
    INVITEE_IS_NOT_EXISTS("002", "被邀请的成员不存在。"),
    INVITER_IS_NOT_A_MEMBER_OF_THE_PROJECT("003", "邀请人并不是当前团队的成员,不允许邀请他人进入该团队。"),
    INVITEE_IS_ALREADY_A_MEMBER_OF_THE_PROJECT("004", "邀请对象已经是该团队成员,无须再次邀请。"),
